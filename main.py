...
while True:
        ...
        os.system("banner Welcome")
        #pyttsx3.speak("Welcome to menu program")
        os.system("tput setaf 7")
        print()
        a = input("""Tell me how can I help you :)\n 
Type "website" ---> for creating single page website
Type "rhel" ---> for run rhel8 commands
Type "docker" ---> for docker container
Type "yum" ---> to configure and use the package installer
Type "exit" ---> to close the program\n\n-----> """)
        ...
        if a == "website":
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("banner  httpd")
                os.system("tput setaf 7")
                print()
                b = int(input("""
Press 1 : To download the Apache httpd software
Press 2 : Start the httpd service
Press 3 : Disabled the firewall and SElinux
Press 4 : Create an website page
Press 5 : See the content of webpage that you created
...
\n\n-----> """))
                if b == 1:
                     ...
                     print("---FIREWALL & SElinux Stopped---\n")
                elif b == 4:
                     html_file = input("Name of an html page file: ")
                     ext=input("extension of file: ")
                     print("Now you can write your code")
                     os.system("time.sleep(3)")

                     os.system("sudo vi /var/www/html/{}.{}".format(html_file,ext))
                     print("---File created successfully---\n")
                elif b == 5:
                     html_file = input("Name of an html page file: ")
                     ext=input("type extension of above file:")
                     os.system("sudo cat /var/www/html/{}.{}".format(html_file,ext))
                elif b == 6:
                     ip_address = input("Enter your IP Address: ")
                     html_file = input("Enter the page name: ")
                     ext=input("Enter the file extension: ")
                     os.system("curl http://{}/{}.{}".format(ip_address,html_file,ext))
                    # os.system("sudo firefox http://{}/{}.{}".format(ip_address,html_file,ext))
                elif b == 7:
                    break
            ...
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("banner Package Installer")
                os.system("tput setaf 7")
                print()
                b = int(input("""
Press 1 : Check the Software Name i.e available or not
Press 2 : See the yum configuration details
Press 3 : Check the software name of commands
Press 4 : (Install/Uninstall) the software
Press 5 : List all the software in yum or check particular software
...
Press 2 : List the Docker Images you have
Press 3 : List all the containers (running and stopped)
Press 4 : List all the running containers
Press 5 : Download or pull the new images
...
Press 11 : Remove  container or Image
...
Press 18 : Run commands in Running  Docker container
...
\n\n-----> """))
                if b == 1:
                    ...
                    c_name=input ("Enter the container name or id : ")
                    cmd=input("Enter the command for run in container: ")
                    os.system("sudo docker start {} ".format(c_name))
                    os.system("time.sleep(3)")
                    os.system("sudo docker exec {} {} ".format(c_name,cmd))
                elif b == 19:
                    break
                else:
                    print("Not Found")
            ...
            while True:
                os.system("clear")
                os.system("tput setaf 6")
                os.system("banner RHEL Commands")
                os.system("tput setaf 7")
                print()
